                        ...
                        <table class="table-striped table-bordered" id="editable-sample">
                            ...
                            <?php foreach ($prescriptions as $prescription) { ?>
                                <tr class="">
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-xs btn_width" href="prescription/viewPrescription?id=<?php echo $prescription->id; ?>"><i class="fa fa-eye"></i> <?php echo lang('view'); ?> <?php echo lang('prescription'); ?></a>   
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
