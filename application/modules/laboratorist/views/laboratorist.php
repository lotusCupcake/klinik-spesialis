...
<div class="main-content">
    <div class="section">
        <div class="section-header">
            <h1><?php echo lang('laboratorist'); ?></h1>
        </div>
        <?php
                            ...
                            <?php foreach ($laboratorists as $laboratorist) { ?>
                                <tr class="">
                                    ...
                                    <td class="no-print">
                                        ...
                                        <a class="btn btn-danger btn-xs btn_width delete_button" href="laboratorist/delete?id=<?php echo $laboratorist->id; ?>" title="<?php echo lang('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i> </a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
...
<div class="modal fade" role="dialog" id="myModal">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="laboratorist/addNew" class="clearfix" method="post" enctype="multipart/form-data">
...
<div class="modal fade" role="dialog" id="myModal2">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="laboratorist/addNew" id="editLaboratoristForm" class="clearfix" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('name'); ?></label>
                        <input type="text" class="form-control" name="name" id="exampleInputEmail1" value=''>
