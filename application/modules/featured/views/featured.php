...
<div class="main-content">
    <div class="section">
        <div class="section-header">
            <h1><?php echo lang('featured_doctors'); ?></h1>
        </div>
        <?php
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <button class="btn btn-icon icon-left btn-primary" data-toggle="modal" data-target="#myModal"><i class="fas fa-plus"></i> <?php echo lang('add_doctor'); ?></button>
                </div>
                <div class="card-body">
                            ...
                            <?php foreach ($featureds as $featured) { ?>
                                <tr class="">
                                    ...
                                    <td class="no-print">
                                        ...
                                        <a class="btn btn-danger btn-xs btn_width delete_button" title="<?php echo lang('delete'); ?>" href="featured/delete?id=<?php echo $featured->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
