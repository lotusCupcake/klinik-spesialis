...
<div class="main-content">
    <div class="section">
        <div class="section-header">
            <h1><?php echo lang('activities_by'); ?> <strong style="color: #009988; text-transform: capitalize;" ><?php echo lang('all_users'); ?></strong> (<?php echo lang('today'); ?>)</h1>
        </div>
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <h5><?php echo lang('today'); ?> <?php echo lang('report'); ?></h5>
                </div>
                <div class="card-body">
