...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            ?>
            <h1><?php echo date('F, Y', $first_minute) . ' ' . lang('pharmacy') . ' ' . lang('expense_report'); ?></h1>
        </div>
        <div class="section-body">
            <div class="card">
                <div class="card-header  no-print">
                    <div style="font-size: 30px;">
                        <a href="finance/pharmacy/dailyExpense?year=<?php echo $previous_year; ?>&month=<?php echo $previous_month; ?>" class="mr-4 "><i class="fa fa-arrow-left"></i></a>
                        <a href="finance/pharmacy/dailyExpense?year=<?php echo $next_year; ?>&month=<?php echo $next_month; ?>"><i class="fa fa-arrow-right"></i></a>
                    </div>
                    <h4></h4>
