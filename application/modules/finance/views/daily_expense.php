...
<div class="main-content">
    <div class="section">
        ...
        <div class="section-header"> 
            <h1 class="col"><?php echo date('F, Y', $first_minute) . ' ' . lang('hospital').' '.lang('expense_report'); ?> </h1>
            <div class="col-md-2 btn-group" role="group" aria-label="Basic example">
                <a class="btn btn-primary no-print" href="finance/dailyExpense?year=<?php echo $previous_year; ?>&month=<?php echo $previous_month; ?>">
                    <i class="fa fa-arrow-left"></i>
                </a>
                <a class="btn btn-primary no-print" href="finance/dailyExpense?year=<?php echo $next_year; ?>&month=<?php echo $next_month; ?>">
